                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7 mb-5 my-lg-5 py-5 pl-lg-5">
                            ...
                            <form method="POST" class="row g-3 needs-validation" novalidate
                                    ...
                                    <div class="col-md-12 mt-2">
                                        <button type="button" onclick="changeEmail(this.form)" class="btn btn-primary">Save changes</button>
                                    </div>
                                    <div class="col-md-12 mt-2">
                                        <a href="profile.php" class="btn btn-info" data-bs-dismiss="modal">Back to Profile</a>
                                    </div>
