            ...
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-3 text-center">
                        ...
                        <a href="<?php echo $res['link_facebook']; ?>" class="pl-0 pr-3"><span
                                class="icon-facebook"></span></a>
                        <a href="<?php echo $res['link_twiiter']; ?>" class="pl-3 pr-3"><span
                                class="icon-twitter"></span></a>
                        <a href="<?php echo $res['link_instragram']; ?>" class="pl-3 pr-3"><span
