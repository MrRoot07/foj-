...
('Header.jpg', 'Welcome to FOJ Express', 'Your Premier Domestic Courier Service Provider', 'About Us', 'FOJ Express is a Sri Lankan premier domestic courier service provider. With the strength of an experienced and talented team, FOJ Express functions with the utmost confidence in the broadest coverage, security, and timely delivery of your important documents and packages. FOJ Express also has a strong background in logistics management. As a result of the trust we have built with our corporate clients, FOJ Express is now the official courier for a number of entities in Sri Lanka. FOJ Express upholds high service standards and quality levels to ensure that your packages and documents are handled by professionals.', '+9477-1233254', 'connect@royalexpress.com', 'No 224, Matara Road, Tangalle, Southern Province, Sri Lanka', 'Sub_Header.jpg', 'About.jpg', 'https://www.facebook.com/', 'https://www.twitter.com/', 'https://www.instagram.com/', 'Background.jpg');
