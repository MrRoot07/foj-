...
('Header.jpg', 'Welcome to Pos laju', 'Your Premier Domestic Courier Service Provider', 'About Us', 'Pos laju is a Sri Lankan premier domestic courier service provider. With the strength of an experienced and talented team, Pos laju functions with the utmost confidence in the broadest coverage, security, and timely delivery of your important documents and packages. Pos laju also has a strong background in logistics management. As a result of the trust we have built with our corporate clients, Pos laju is now the official courier for a number of entities in Sri Lanka. Pos laju upholds high service standards and quality levels to ensure that your packages and documents are handled by professionals.', '+9477-1233254', 'connect@royalexpress.com', 'No 224, Matara Road, Tangalle, Southern Province, Sri Lanka', 'Sub_Header.jpg', 'About.jpg', 'https://www.facebook.com/', 'https://www.twitter.com/', 'https://www.instagram.com/', 'Background.jpg');
